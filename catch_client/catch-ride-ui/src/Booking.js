                    ...
                    <tbody>
                        {getBookings.map((booking) => (
                            <tr key={booking.bookingId}>
                                ...
                                <td>
                                    <Link className="btn btn-info" to={`/booking/edit/${booking.bookingId}`} state={{vehicleId: booking.vehicleId, userId: localStorage.getItem('appUserId'), dealershipLocationId: booking.dealershipLocationId}}>Edit</Link>
